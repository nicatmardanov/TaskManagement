    ...
    $(document).ready(function () {
        ...
        neonRegister.$container.validate({
            ...
            submitHandler: function (ev) {
                ...
                if ($("input#email").val().length > 0 && $("input#password").val().length > 0 && $("input#position").val().length > 0 && $("input#department").attr("data-id") != undefined) {
                    $.ajax({
                        type: 'get',
                        url: '/Register/CheckMail?email=' + $("input#email").val(),
                        success: function (result) {
                            if (result.res == "1") {
                                    ...
                                    neonRegister.setPercentage(98, function () {
                                        ...
                                        $.ajax({
                                            ...
                                            data: {
                                                ...
                                                DepartmentId: $("input#department").data('id')
                                            },
                                            error: function () {
                                ...
                                alert('Bu email sistemdə mövcuddur. Başqa email daxil edin!');
                            }
                        }
                    })
                }
